...
var AmazonWebService = (function(){
    ...
    function RegisterListeners(){
        ...
        $("#CreateInstanceButton").click(function(){
            ...
            createEC2Instance({KeyName: KeyPairName,ImageId: awsOS, instanceType: instanceType, instanceName: instanceName, instanceDiskSize: awsDiskSize});
    ...
    * */
    ...
    function createEC2Instance(instanceObj) {
        ...
        if(instanceObj==null || instanceObj.KeyName == null){
            console.log("missing object or key name");
            return false;
        }
