...
$('#service_selector').change(function(){   
	var opt = $(this).val();
	if (opt == "aws") {
		$("#size_selector").html("<option value=\"t2.micro\" selected=\"selected\">Small (t2.micro) </option>"+
		...
		$("#region_selector").html('<option value="us-east-1">Virginia</option>'+
...
'                            </a>'+
		...
		//$("#myModalNorm").html('<div class="form-group">'+
                                       // <label id="publicKeyLabel">AWS Public Key</label>
...
'                                    <form role="form" id="keyForm">'+
'                                      <div class="form-group">'+
'                                        <label id="publicKeyLabel">Public Key</label>'+
'                                        <input id="publicKey" type="email" class="form-control"'+
'                                        placeholder="Public Key"/>'+
'                                    </div>'+
'                                    <div class="form-group">'+
'                                        <label for="publicKeyLabel">Secret Key</label>'+
...
'                            </a>'+
 ...
 '               </div>'
		...
		$("#keyPairForm").html('<div class="form-group">'+
...
$("#creatButton").click(function(){
  ...
  console.log(serviceProvider);
	...
	if(serviceProvider=="aliyun"){
		...
		accessKeyId = $("#awsPublicKey").val();
		secretAccessKey = $("#awsSecretKey").val();
		prepareParameterForAWS();
	}	
});

function prepareParameterForAWS(){
